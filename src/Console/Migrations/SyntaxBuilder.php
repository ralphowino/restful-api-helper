...
namespace Ralphowino\ApiStarter\Console\Migrations;
...
class SyntaxBuilder
{
    ...
    /**
     * Determine if should have soft-delete
     *
     * @var bool
     */
    private $archives;
     ...
     * @throws \Exception
     */
    public function create($schema, $meta, $archives = false)
    {
    ...
    {
        if(!$schema && !$this->archives) return '';
        ...
        //Check if soft-delete is necessary
        if($this->archives) {
